...
//property 13 (Premium 4 BHK in DLF Phase 1, > 1Cr, Ready to Move)
Property(
  id: '13',
  ...
  sector: 26,
  price: 22000000,
  amenities: ['gym', 'pool', 'gated society', 'metro', 'sunlight'],
  furnishing: 'furnished',
  ageYears: 2,
  floor: 12,
  totalFloors: 15,
  nearbySchools: ['Pathways', 'GD Goenka'],
  nearbyHospitals: ['Fortis'],
  parking: 3,
),

//property 14 (3 BHK in Sector 50, 80L-1Cr, Within 1 Year)
Property(
  id: '14',
  ...
  sector: 50,
  price: 9500000,
  amenities: ['gym', 'park', 'gated society', 'metro'],
  furnishing: 'semi-furnished',
  ageYears: 1,
  floor: 6,
  totalFloors: 12,
...
//property 15 (2 BHK in Sector 57, 50-80L, Under Construction)
Property(
  id: '15',
  imageUrl: 'https://images.unsplash.com/photo-1512915922686-57c11dde9b6b?w=800&auto=format&fit=crop&q=80',
  bhk: 2,
  area: 1220,
  location: 'Sector 57, Gurgaon',
  sector: 57,
  price: 6200000,
  amenities: ['park', 'sunlight'],
  furnishing: 'unfurnished',
  ageYears: 0,
  floor: 3,
  totalFloors: 8,
...
//property 16 (Affordable 1 BHK in Sohna Road, Under 50L, Under Construction)
Property(
  id: '16',
  imageUrl: 'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=800&auto=format&fit=crop&q=80',
  bhk: 1,
...
//property 17 (3 BHK in Golf Course Road, > 1Cr, Ready to Move)
Property(
  id: '17',
  imageUrl: 'https://images.unsplash.com/photo-1580587771525-78b9dba3b914?w=800&auto=format&fit=crop&q=80',
  bhk: 3,
  ...
  sector: 54,
  price: 18000000,
  amenities: ['gym', 'pool', 'gated society', 'sunlight'],
  furnishing: 'furnished',
  ageYears: 3,
  floor: 15,
  totalFloors: 25,
...
//property 18 (4 BHK in Sector 50, > 1Cr, Within 1 Year)
Property(
  id: '18',
  imageUrl: 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=800&auto=format&fit=crop&q=80',
  bhk: 4,
  ...
  sector: 50,
  price: 16000000,
  amenities: ['pool', 'gym', 'gated society', 'metro'],
  furnishing: 'semi-furnished',
  ageYears: 1,
  floor: 8,
  totalFloors: 14,
  nearbySchools: ['DPS', 'GD Goenka'],
  nearbyHospitals: ['Medanta'],
  parking: 2,
),

//property 19 (2 BHK in DLF Phase 1, 80L-1Cr, Ready to Move)
Property(
  id: '19',
  imageUrl: 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=800&auto=format&fit=crop&q=80',
  bhk: 2,
...
//property 20 (3 BHK in Sohna Road, 50-80L, Ready to Move)
Property(
  id: '20',
  imageUrl: 'https://images.unsplash.com/photo-1484154218962-a197022b5858?w=800&auto=format&fit=crop&q=80',
  bhk: 3,
...
//property 21 (1 BHK in Sector 57, Under 50L, Within 1 Year)
Property(
  id: '21',
  imageUrl: 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=800&auto=format&fit=crop&q=80',
  bhk: 1,
...
//property 22 (2 BHK in Golf Course Road, 80L-1Cr, Under Construction)
Property(
  id: '22',
  imageUrl: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=800&auto=format&fit=crop&q=80',
  bhk: 2,
...
//property 23 (3 BHK in DLF Phase 1, > 1Cr, Ready to Move)
Property(
  id: '23',
  imageUrl: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=800&auto=format&fit=crop&q=80',
  bhk: 3,
  ...
  floor: 9,
  totalFloors: 16,
  nearbySchools: ['Shriram', 'Pathways'],
  nearbyHospitals: ['Fortis'],
  parking: 2,
),

//property 24 (4 BHK in Sohna Road, > 1Cr, Ready to Move)
Property(
  id: '24',
  imageUrl: 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=800&auto=format&fit=crop&q=80',
  bhk: 4,
